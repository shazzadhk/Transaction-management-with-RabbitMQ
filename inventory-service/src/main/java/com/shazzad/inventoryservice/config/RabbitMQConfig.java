package com.shazzad.inventoryservice.config;
...
//    @Value("${queue.bill-create}")
//    private String billOrderQueue;
...
//    @Bean
//    public Queue billCreateQueue(){
//        return new Queue(billOrderQueue);
//    }
...
//    @Bean
//    public Binding billCreateBinding(){
//        return BindingBuilder
//                .bind(billCreateQueue())
//                .to(exchange())
//                .with(billCreateRoutingKey);
//    }
